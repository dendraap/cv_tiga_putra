@extends('layouts.app', ['activePage' => 'user-management', 'titlePage' => __('Add Employees - Manage Employees'), 'title' => __('Add Employees - Manage Employees')])
                ...
                <form method="post" action="/user" class="form-horizontal">
                    ...
                    <div class="card">
                        <div class="card-header card-header-primary">
                            ...
                            <p class="card-category">Here is you can add new employees in CV Tiga Putra</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-role-name" type="text" placeholder="{{ __('') }}" required value="{{ old('name') }}"/>
                                        @if ($errors->has('name'))
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" id="input-email" type="email" placeholder="{{ __('') }}" required value="{{ old('email') }}"/>
                                        @if ($errors->has('email'))
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('telepon') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('telepon') ? ' is-invalid' : '' }}" name="telepon" id="telepon" type="text" placeholder="{{ __('') }}" required value="{{ old('telepon') }}"/>
