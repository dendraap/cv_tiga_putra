    ...
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="{{ route('register') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body ">
            <p class="card-description text-center">{{ __('Buat akun admin') }}</p>
            ...
            <div class="bmd-form-group{{ $errors->has('role') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input type="text" name="role" id="role" class="form-control" placeholder="{{ __('') }}" value="Admin" required readonly>
              </div>
            </div>
            ...
            <div class="bmd-form-group{{ $errors->has('role') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input type="text" name="telepon" id="telepon" class="form-control" placeholder="{{ __('') }}" value="082351209697" required readonly>
              </div>
            </div>
