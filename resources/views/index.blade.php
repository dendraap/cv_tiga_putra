                      ...
                      <ul class="nav">
                        <li class="nav-item">
                          <a class="nav-link" href="{{ route('profile.edit') }}">
                            ...
                            <span class="sidebar-normal">{{ __('Manage Admin') }} </span>
                          </a>
                        </li>
                        <li class="nav-item active">
                          <a class="nav-link" href="{{ route('user.index') }}">
                            <span class="sidebar-mini"> MK </span>
                            <span class="sidebar-normal"> {{ __('Manage Karyawan') }} </span>
                          </a>
                        </li>
                      </ul>
                    </div>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('table') }}">
                      <i class="material-icons">content_paste</i>
                        <p>{{ __('Gaji Karyawan') }}</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('kehadiran') }}">
                      <i class="material-icons">cheklist</i>
                        <p>{{ __('Kehadiran') }}</p>
                    </a>
                  </li>
                  <li class="nav-item">
